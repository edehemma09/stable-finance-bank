...
import { LayoutDashboard, Users, FileEdit, Settings, LifeBuoy, ShieldCheck, Landmark, FileCheck2, Trash2, Mail, Siren } from "lucide-react";
...
const NAV = [
  ...
  { to: "/admin/errors", label: "Diagnostics", icon: Siren },
